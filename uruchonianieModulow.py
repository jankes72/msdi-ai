...
harmonogram = {
    ...
    'SSI_V5_SPORTS_WORLD_MODEL_GENERATOR.py': ['08:05'], # tu jest wpisany na końcu kodu ten kod start_ssi_test.py
    'start_ssi_test.py': ['15:07'],
    'start_ssi_test.py': ['21:07'],
}
